...
temp_cols <- brandtools::lumanity_palettes$neutral
names(temp_cols) <- c("A", "B", "C")

# create the CEP
darkpeak::makeCEPlane(total_costs = results_C,
...
darkpeak::makeCEAC(total_costs = results_C,
                   total_qalys = results_Q,
                   treatment = c("A", "B", "C"),
                   lambda_min = 0,
                   lambda_max = 100000) + 
  ggplot2::scale_colour_manual(values = temp_cols)
