...
author:
  ...
  - name: Paul P Schneider
    ...
    - 2
    - 3
    email: pschneider@darkpeakanalytics.com
    corresponding: FALSE
  - name: Wael Mohammed
    affil: 
    - 2
...
abstract: |
  ...
  Method
  We developed an automated analysis and reporting pipeline for health economic modelling and made the source code openly available on a [GitHub](https://github.com/RobertASmithBresMed/plumberHE) repository. It consists of three parts:
...
```{r, echo=FALSE, out.width="90%", fig.cap="Schematic showing the interaction between the Company API and the Consultant Automated Workflow"}
...
::: {.tiny}
```{r, eval = F, echo = T, attr.source='.numberLines'}
